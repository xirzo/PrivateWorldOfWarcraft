...
//
// Vendored from rqbit and patched: the `sha1-ring` feature uses `ring`
// instead of `aws-lc-rs`, keeping the whole binary free of the C `aws-lc`
// dependency so it can link statically against musl.

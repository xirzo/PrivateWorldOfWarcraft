...
## Russian localization (ruRU) (OPTIONAL)

If you want the Russian localization, download `wow-ruRU-3.3.5a.zip` (~2.5 GB) from
[Google Drive](https://drive.google.com/file/d/12qOajbaFvaeBxGHezmYk27dcn7Q8BnyL/view?usp=sharing)
and extract its contents into the game root folder (it adds `Data/ruRU/`). Then open
*WTF/Config.wtf* in a text editor and replace *SET locale "enUS"* with *SET locale "ruRU"*.
